...
public class ColorMappingColorChooserTest {
	...
	public void testCreateIterSpectrumMap() {
		...
		//create IterCountMap because iterSpectrumMap depends on iterCountMap
		...
		// test for equality of all values
		for (Integer key : testKeySet) {
	...
	public void testCreateIterColorMap() {
		...
		//creating iterCountMap and iterSpectrumMap because iterColorMap depends on them
		chooser.createIterCountMap(iterCounts);
		chooser.createIterSpectrumMap();
		
		//creating iterColorMap and retrieve it
		...
		// test for equality of all value but using .equals to compare objects
		for (Integer key : testKeySet) {
